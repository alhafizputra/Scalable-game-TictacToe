...
public class TTTConsoleNonOO2P {
    ...
    public static void main(String[] args) {
        ...
        initGame();
        if (ROWS < 3) {
            System.out.println("Minimum required rows and columns are 3!");
            System.out.println("Do you want to repeat? (y/n)");
            String repeat;
            repeat = in.next();
            TTTConsoleNonOO2P ttt = new TTTConsoleNonOO2P();
            if (repeat.equals("y")) {
                ttt.main(null);
    ...
    public static void initGame() {
        System.out.print("Generate ROW & COLUMN : ");
        ROWS = in.nextInt();
        COLS = ROWS;
    ...
    public static void playerMove(int theSeed) {
        ...
        do {
            if (theSeed == CROSS) {
                ...
                System.out.print("Player 'O', enter your move (row[1-" + COLS + "] column[1-" + COLS + "]): ");
            }
    ...
    public static void printBoard() {
        for (int row = 0; row < ROWS; ++row) {
            ...
            System.out.println();
            if (row != ROWS - 1) {
                for (int row1 = 0; row1 < (ROWS * 3) + (ROWS - 1); ++row1) {
